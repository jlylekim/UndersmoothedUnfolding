...
////////////////////////////////////////////////////////////////////////
///
TVectorD TUnfold::ComputeCoverageOracle(TH1 *hist_beta, Double_t tau)
{
  // converting TH1 hist_beta to TMatrixD beta
  // doesn't need unless I want to input TH1 instead of TMatrixD
  TMatrixD *beta;
  ...
  */
  ...
  if (fBiasScale != 0.0) {
    TMatrixDSparse *lSquaredScaled = &((*lSquared)*=tau*tau);     //this is how to scale a sparse matrix
